...
describe('Working Holiday', () => {
  ...
  test('income between $37,001 – $87,000, tax on this income $5,550 plus 32.5c for each $1 over $37,000', () => {
    const tax = TaxFactory.create({
      type: 'working_holiday',
      income: 37001
    });
  ...
  test('income between $87,001 – $180,000, tax on this income $21,800 plus 37c for each $1 over $87,000', () => {
    const tax = TaxFactory.create({
      type: 'working_holiday',
      income: 160000
    });
  ...
  test('income between $180,001 and over, tax on this income $56,210 plus 45c for each $1 over $180,000', () => {
    const tax = TaxFactory.create({
      type: 'working_holiday',
      income: 200000
    });
